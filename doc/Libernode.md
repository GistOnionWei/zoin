...
**3.1.**  Start daemon in testnet mode:
    ...
    ./src/libercoind -daemon -server -testnet
...
**3.4.**  Send to received address **exactly 25000 LBR** in **1 transaction**. Wait for 6 confirmations.
...
**4.2.**  Create file **zonode.conf** (in 2 folders **~/.libercoin** and **~/.libercoin/testnet3**) contains the following info:
 ...
 - TRANSACTION HASH: The collateral tx. hash from the 25000 LBR deposit.
