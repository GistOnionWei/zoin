...
void TransactionView::setModel(WalletModel *model)
{
    ...
    if(model)
    {
        ...
        transactionView->horizontalHeader()->setStyleSheet("QHeaderView::section {height:50; border: none; background-color: #321172; color: white; font-size: 12pt \"LibercoinRegular\"; padding-left: 10; padding-right:10; } QHeaderView::down-arrow { image: url(:/icons/txdown); width: 8px; height: 8px; } QHeaderView::up-arrow { image: url(:/icons/txup); width: 8px; height: 8px; } ");
